...
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  /* TODO: Move xfwm_make_display_name to libexpidus1ui */
 ...
 * (if Libexpidus1ui was built with startup notification support).
 *
 * Return value: %TRUE on success, %FALSE if @error is set.
 * 
